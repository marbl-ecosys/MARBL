...
settings_latest.yaml and diagnostics_latest.yaml which should be generated by
...
def _parse_args(marbl_root):
    ...
    parser.add_argument('-s', '--settings_file', action='store', dest='settings_file',
                        default=os.path.join(marbl_root, 'defaults', 'settings_latest.yaml'),
    ...
    parser.add_argument('-d', '--diags_file', action='store', dest='diags_file',
                        default=os.path.join(marbl_root, 'defaults', 'diagnostics_latest.yaml'),
