...
! -D_NETCDF this module does not include netCDF functions but will not provide any I/O)
  ...
  public :: marbl_netcdf_read_field
  public :: marbl_netcdf_define_history
  public :: marbl_netcdf_write_history
...
contains
  ...
  subroutine marbl_netcdf_define_history(marbl_instances, col_cnt, hist_file, driver_status_log)
    ...
    character(len=*), parameter :: subname = 'marbl_netcdf_mod:marbl_netcdf_define_history'
  ...
  end subroutine marbl_netcdf_define_history

  !*****************************************************************************

  subroutine marbl_netcdf_write_history(hist_file, marbl_instance, surface_fluxes, interior_tendencies, &
    ...
    character(len=*), parameter :: subname = 'marbl_netcdf_mod:marbl_netcdf_write_history'
    character(len=char_len) :: log_message
  ...
  end subroutine marbl_netcdf_write_history
  ...
  function get_nc_file_id(file_name, driver_status_log)
    ...
    character(len=*), parameter :: subname = 'marbl_netcdf_mod:get_nc_file_id'
    character(len=char_len) :: log_message
  ...
  subroutine define_diag(file_id, diag, diag_ind, varid, driver_status_log)
    ...
    character(len=*), parameter :: subname = 'marbl_netcdf_mod:define_diag'
  ...
  subroutine write_diag(file_id, diag, num_active_levels, varid, mask_2d, driver_status_log)
    ...
    character(len=*), parameter :: subname = 'marbl_netcdf_mod:write_diag'
    integer :: col_id
