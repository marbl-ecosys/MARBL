...
contains
  ...
  subroutine marbl_interior_tendency_compute( &
    ...
    call compute_PAR(domain, interior_forcings, interior_forcing_indices, &
                     totalChl_local, PAR)
  ...
  subroutine compute_PAR(domain, interior_forcings, interior_forcing_ind, &
                         totalChl_local, PAR)
   ...
   subroutine compute_Zprime(k, domain, zooC, Tfunc, zooplankton_secondary_species)
