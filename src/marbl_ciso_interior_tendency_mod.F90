...
contains
  ...
  subroutine update_particulate_terms_from_prior_level(k, POC_ciso, P_CaCO3_ciso)
    ...
    if (k > 1) then
       call marbl_interior_share_update_sinking_particle_from_level_above(k, POC_ciso)
       call marbl_interior_share_update_sinking_particle_from_level_above(k, P_CaCO3_ciso)
    end if
